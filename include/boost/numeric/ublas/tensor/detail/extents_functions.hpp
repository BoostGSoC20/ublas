...
constexpr auto squeeze_impl_remove_one(basic_static_extents<T, E0, E...>,
...
template <class T, T... E> constexpr auto squeeze_impl(basic_static_extents<T, E...> const &e)
{
...
template <class T, std::size_t N> inline auto squeeze_impl(basic_fixed_rank_extents<T, N> const &e)
{
    if constexpr (N <= 2)
    {
        return e;
...
template <class ExtentsType>[[nodiscard]] inline constexpr bool valid(ExtentsType const &e)
{
 ...
 */
template <class ExtentsType>[[nodiscard]] inline constexpr bool is_scalar(ExtentsType const &e)
{

    static_assert(is_extents_v<ExtentsType>,
                  "boost::numeric::ublas::is_scalar() : invalid type, type should be an extents");
 ...
 */
template <class ExtentsType>[[nodiscard]] inline constexpr bool is_vector(ExtentsType const &e)
{

    static_assert(is_extents_v<ExtentsType>,
                  "boost::numeric::ublas::is_vector() : invalid type, type should be an extents");
    ...
    if (e.size() == 0u)
        ...
        return std::any_of(e.begin(), e.begin() + 2, greater_one) && std::any_of(e.begin(), e.begin() + 2, equal_one) &&
 ...
 */
template <class ExtentsType>[[nodiscard]] inline constexpr bool is_matrix(ExtentsType const &e)
{

    static_assert(is_extents_v<ExtentsType>,
                  "boost::numeric::ublas::is_matrix() : invalid type, type should be an extents");
 ...
 */
template <class ExtentsType>[[nodiscard]] inline constexpr bool is_tensor(ExtentsType const &e)
{

    static_assert(is_extents_v<ExtentsType>,
                  "boost::numeric::ublas::is_tensor() : invalid type, type should be an extents");
 ...
 */
template <class ExtentsType>[[nodiscard]] inline auto squeeze(ExtentsType const &e)
{

    static_assert(is_extents_v<ExtentsType>,
                  "boost::numeric::ublas::squeeze() : invalid type, type should be an extents");

    return detail::squeeze_impl(e);
}

/** @brief Returns the product of extents */
template <class ExtentsType>[[nodiscard]] inline constexpr auto product(ExtentsType const &e)
{

    static_assert(is_extents_v<ExtentsType>,
                  "boost::numeric::ublas::product() : invalid type, type should be an extents");
...
template <class LExtents, class RExtents, std::enable_if_t<is_extents_v<LExtents> && is_extents_v<RExtents>, int> = 0>
[[nodiscard]] inline constexpr bool operator==(LExtents const &lhs, RExtents const &rhs) noexcept
{

    static_assert(
        std::is_same_v<typename LExtents::value_type, typename RExtents::value_type>,
