...
template <std::size_t I> struct index_type
{
    ...
    constexpr bool operator==(std::size_t other) const
    {
        return value == other;
    }
    constexpr bool operator!=(std::size_t other) const
    ...
    template <std::size_t K> constexpr bool operator==(index_type<K> /*other*/) const
    {
        return I == K;
    }
    template <std::size_t K> constexpr bool operator!=(index_type<K> /*other*/) const
    ...
    constexpr bool operator==(index_type /*other*/) const
    {
        return true;
    }
    constexpr bool operator!=(index_type /*other*/) const
