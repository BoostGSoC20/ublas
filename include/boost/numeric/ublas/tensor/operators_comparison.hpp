...
[[nodiscard]] inline constexpr bool compare(basic_tensor<T1> const &lhs, basic_tensor<T2> const &rhs, BinaryPred pred)
{
    ...
    if (lhs.extents() != rhs.extents())
    {
        if constexpr (!std::is_same<BinaryPred, std::equal_to<>>::value &&
            ...
            throw std::runtime_error(
                "Error in boost::numeric::ublas::detail::compare: cannot compare tensors with different shapes.");
        else
            return false;
    }
...
[[nodiscard]] inline constexpr bool compare(basic_tensor<T> const &rhs, UnaryPred pred)
{
...
[[nodiscard]] constexpr bool compare(tensor_expression<T1, L> const &lhs, tensor_expression<T2, R> const &rhs,
                                     BinaryPred pred)
{
...
[[nodiscard]] constexpr bool compare(tensor_expression<T, D> const &expr, UnaryPred pred)
{
...
[[nodiscard]] inline constexpr bool operator==(boost::numeric::ublas::detail::tensor_expression<T1, L> const &lhs,
...
template <class T1, class T2, class L, class R>
[[nodiscard]] inline constexpr auto operator!=(boost::numeric::ublas::detail::tensor_expression<T1, L> const &lhs,
                                               boost::numeric::ublas::detail::tensor_expression<T2, R> const &rhs)
{
...
[[nodiscard]] inline constexpr bool operator==(typename T::const_reference lhs,
...
template <class T, class D>
[[nodiscard]] inline constexpr auto operator!=(typename T::const_reference lhs,
                                               boost::numeric::ublas::detail::tensor_expression<T, D> const &rhs)
{
    return boost::numeric::ublas::detail::compare(rhs, [lhs](auto const &r) { return lhs != r; });
}
...
template <class T, class D>
[[nodiscard]] inline constexpr auto operator!=(boost::numeric::ublas::detail::tensor_expression<T, D> const &lhs,
