...
#define FIRST_ORDER_OPERATOR_RIGHT(OP, EXPR_TYPE_L, EXPR_TYPE_R)                                                       \
    ...
    auto operator OP(boost::numeric::ublas::EXPR_TYPE_L<T, L> const &lhs,                                              \
                     boost::numeric::ublas::EXPR_TYPE_R<R> const &rhs)                                                 \
    {                                                                                                                  \
        return boost::numeric::ublas::detail::make_binary_tensor_expression<T>(                                        \
            lhs(), rhs(), [](auto const &l, auto const &r) { return l OP r; });                                        \
    }
...
#define FIRST_ORDER_OPERATOR_LEFT(OP, EXPR_TYPE_L, EXPR_TYPE_R)                                                        \
    template <class T, class L, class R>                                                                               \
    auto operator OP(boost::numeric::ublas::EXPR_TYPE_L<L> const &lhs,                                                 \
                     boost::numeric::ublas::EXPR_TYPE_R<T, R> const &rhs)                                              \
    {                                                                                                                  \
        return boost::numeric::ublas::detail::make_binary_tensor_expression<T>(                                        \
            lhs(), rhs(), [](auto const &l, auto const &r) { return l OP r; });                                        \
    }
    ...
    boost::numeric::ublas::detail::tensor_expression<boost::numeric::ublas::basic_tensor<T>, R> const &rhs)
{
    ...
    return boost::numeric::ublas::detail::make_unary_tensor_expression<basic_tensor_type>(
...
constexpr auto operator+(
    boost::numeric::ublas::detail::tensor_expression<boost::numeric::ublas::basic_tensor<T>, L> const &lhs,
...
constexpr auto &operator+=(
    boost::numeric::ublas::basic_tensor<T> &lhs,
...
template <class T, class D> constexpr auto operator-(boost::numeric::ublas::detail::tensor_expression<T, D> const &lhs)
{
