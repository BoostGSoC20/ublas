...
template <class value_type> void print(std::ostream &out, const std::complex<value_type> &p)
{
...
template <typename T> std::ostream &operator<<(std::ostream &out, boost::numeric::ublas::basic_tensor<T> const &t)
{
...
template <class T,
          std::enable_if_t<boost::numeric::ublas::is_strides_v<T> || boost::numeric::ublas::is_extents_v<T>, int> = 0>
