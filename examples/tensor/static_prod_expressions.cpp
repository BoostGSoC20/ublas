...
int main()
{
    ...
    // static_extents
    {
        ...
        q = 1u;
        static_tensor<value_t, static_extents<4, 2>> C1 =
            matrix_t(n[1], n[2], 2) + prod<1ul /* q = 1 */>(A, vector_t(n[q - 1], 1));
    ...
    // static_extents
    {
        ...
        q = 1ul;
        static_tensor<value_t, static_extents<5, 4, 2>> C1 =
            static_tensor<value_t, static_extents<m, 4, 2>>(value_t(2)) +
        ...
        q = 3u;
        auto C3 = prod<3ul, m + 2>(prod<2ul /* q(3) - 1 = 2 */, m + 1>(A, matrix_t(m + 1, n[q - 2], 1)),
        ...
        std::cout << "% C3 and C4 should have the same values, true? " << std::boolalpha << (C3 == C4) << "!"
                  << std::endl;
    }
}
