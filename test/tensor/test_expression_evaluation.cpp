...
BOOST_FIXTURE_TEST_CASE_TEMPLATE(test_tensor_expression_retrieve_extents, value, test_types, fixture)
{
    ...
    for (auto i = 0u; i < extents.size() - 1; ++i)
    {
        ...
        auto bexpr_bexpr_uexpr1 =
            ublas::detail::make_binary_tensor_expression<basic_tensor_type>(bexpr_uexpr, t2, bminus);
        ...
        auto bexpr_bexpr_uexpr2 =
            ublas::detail::make_binary_tensor_expression<basic_tensor_type>(t2, bexpr_uexpr, bminus);
...
BOOST_FIXTURE_TEST_CASE_TEMPLATE(test_tensor_expression_all_extents_equal, value, test_types, fixture)
{
    ...
    for (auto i = 0u; i < extents.size() - 1; ++i)
    {
        ...
        BOOST_CHECK(
            !ublas::detail::all_extents_equal(bexpr_bexpr_uexpr1, ublas::detail::retrieve_extents(bexpr_bexpr_uexpr1)));
        ...
        BOOST_CHECK(
            !ublas::detail::all_extents_equal(bexpr_bexpr_uexpr2, ublas::detail::retrieve_extents(bexpr_bexpr_uexpr2)));
        ...
        auto bexpr_bexpr_uexpr3 =
            ublas::detail::make_binary_tensor_expression<basic_tensor_type>(bexpr_uexpr2, t1, bplus);
        BOOST_CHECK(
            !ublas::detail::all_extents_equal(bexpr_bexpr_uexpr3, ublas::detail::retrieve_extents(bexpr_bexpr_uexpr3)));

        // bexpr_uexpr2 = t1 + (((t1+1) + t2) + t1)
        auto bexpr_bexpr_uexpr4 =
            ublas::detail::make_binary_tensor_expression<basic_tensor_type>(t1, bexpr_bexpr_uexpr3, bplus);
        BOOST_CHECK(
            !ublas::detail::all_extents_equal(bexpr_bexpr_uexpr4, ublas::detail::retrieve_extents(bexpr_bexpr_uexpr4)));
    }
}
