...
struct fixture
{
    template <size_t N> using extents_type = boost::numeric::ublas::dynamic_extents<N>;
    ...
    std::tuple<extents_type<0>, // 0
               ...
               extents_type<4>  // 9
               >
        extents = {extents_type<0>{},          extents_type<2>{1, 1},    extents_type<2>{1, 2},
                   extents_type<2>{2, 1},      extents_type<2>{2, 3},    extents_type<3>{2, 3, 1},
                   extents_type<3>{4, 1, 3},   extents_type<3>{1, 2, 3}, extents_type<3>{4, 2, 3},
...
BOOST_FIXTURE_TEST_CASE_TEMPLATE(test_fixed_rank_tensor_expression_retrieve_extents, value, test_types, fixture)
{
    ...
    for_each_tuple(extents, [&](auto const &, auto &e) {
        ...
        auto bexpr_bexpr_uexpr =
            ublas::detail::make_binary_tensor_expression<basic_tensor_type>(bexpr_uexpr, t, bminus);
    ...
    for_each_tuple(extents, [&](auto const &I, auto &e1) {
        ...
        for_each_tuple(extents, [&](auto const &J, auto &e2) {
            ...
            if constexpr (extents_type1::_size == extents_type2::_size)
            {
                ...
                auto bexpr_uexpr =
                    ublas::detail::make_binary_tensor_expression<basic_tensor_type1>(uexpr1, uexpr2, bplus);
                ...
                auto bexpr_bexpr_uexpr1 =
                    ublas::detail::make_binary_tensor_expression<basic_tensor_type1>(bexpr_uexpr, t2, bminus);
                ...
                auto bexpr_bexpr_uexpr2 =
                    ublas::detail::make_binary_tensor_expression<basic_tensor_type1>(t2, bexpr_uexpr, bminus);
    ...
    for_each_tuple(extents, [&](auto const &I, auto &e1) {
        ...
        for_each_tuple(extents, [&](auto const &J, auto &e2) {
            ...
            if constexpr (extents_type1::_size == extents_type2::_size)
            {
                ...
                BOOST_CHECK(
                    !ublas::detail::all_extents_equal(bexpr_uexpr, ublas::detail::retrieve_extents(bexpr_uexpr)));

                // bexpr_bexpr_uexpr = ((t1+1) + (2+t2)) - t2
                auto bexpr_bexpr_uexpr1 =
                    ublas::detail::make_binary_tensor_expression<basic_tensor_type1>(bexpr_uexpr, t2, bminus);

                BOOST_CHECK(!ublas::detail::all_extents_equal(bexpr_bexpr_uexpr1,
                ...
                BOOST_CHECK(!ublas::detail::all_extents_equal(bexpr_bexpr_uexpr2,
                ...
                BOOST_CHECK(
                    !ublas::detail::all_extents_equal(bexpr_uexpr2, ublas::detail::retrieve_extents(bexpr_uexpr2)));

                // bexpr_uexpr2 = ((t1+1) + t2) + t1
                auto bexpr_bexpr_uexpr3 =
                    ublas::detail::make_binary_tensor_expression<basic_tensor_type1>(bexpr_uexpr2, t1, bplus);
                BOOST_CHECK(!ublas::detail::all_extents_equal(bexpr_bexpr_uexpr3,
                                                              ublas::detail::retrieve_extents(bexpr_bexpr_uexpr3)));

                // bexpr_uexpr2 = t1 + (((t1+1) + t2) + t1)
                auto bexpr_bexpr_uexpr4 =
                    ublas::detail::make_binary_tensor_expression<basic_tensor_type1>(t1, bexpr_bexpr_uexpr3, bplus);
                BOOST_CHECK(!ublas::detail::all_extents_equal(bexpr_bexpr_uexpr4,
