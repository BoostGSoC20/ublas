...
template <size_t... E> using extents_type = boost::numeric::ublas::basic_static_extents<unsigned, E...>;
template <class E, class L> using strides_type = boost::numeric::ublas::strides_t<E, L>;
