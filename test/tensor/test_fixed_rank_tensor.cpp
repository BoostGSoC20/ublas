...
struct fixture
{
    ...
    std::tuple<extents_type<2>, // 1
               ...
               extents_type<4>  // 5
               >
        extents = {extents_type<2>{1, 1}, extents_type<2>{2, 3}, extents_type<3>{4, 1, 3}, extents_type<3>{4, 2, 3},
...
BOOST_FIXTURE_TEST_CASE_TEMPLATE(test_tensor_copy_ctor_layout, value, test_types, fixture)
{
    ...
    using other_layout_type =
        std::conditional_t<std::is_same<ublas::first_order, layout_type>::value, ublas::last_order, ublas::first_order>;
...
BOOST_FIXTURE_TEST_CASE_TEMPLATE(test_tensor_ctor_extents_init, value, test_types, fixture)
{
    ...
    using distribution_type = std::conditional_t<std::is_integral_v<value_type>, std::uniform_int_distribution<>,
