...
struct fixture
{
    ...
    template <size_t N> using static_rank_extents_type = boost::numeric::ublas::dynamic_extents<N>;
...
BOOST_FIXTURE_TEST_CASE(test_extents_access, fixture,
                        *boost::unit_test::label("extents") * boost::unit_test::label("access"))
{
    using namespace boost::numeric;
...
BOOST_FIXTURE_TEST_CASE(test_extents_copy_ctor, fixture,
                        *boost::unit_test::label("extents") * boost::unit_test::label("copy_ctor"))
{
    BOOST_REQUIRE_EQUAL(extents.size(), 18);
...
BOOST_FIXTURE_TEST_CASE(test_extents_is, fixture,
                        *boost::unit_test::label("extents") * boost::unit_test::label("query"))
{
    BOOST_REQUIRE_EQUAL(extents.size(), 18);
...
BOOST_FIXTURE_TEST_CASE(test_extents_squeeze, fixture,
                        *boost::unit_test::label("extents") * boost::unit_test::label("squeeze"))
{
    BOOST_REQUIRE_EQUAL(extents.size(), 18);
...
BOOST_FIXTURE_TEST_CASE(test_extents_comparison, fixture,
                        *boost::unit_test::label("extents") * boost::unit_test::label("compare"))
{
...
BOOST_FIXTURE_TEST_CASE(test_extents_product, fixture,
                        *boost::unit_test::label("extents") * boost::unit_test::label("product"))
{
