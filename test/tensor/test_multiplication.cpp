...
BOOST_FIXTURE_TEST_CASE_TEMPLATE(test_tensor_mtv, value, test_types, fixture)
{
    ...
    for (auto const &na : extents)
    {
        ...
        for (auto m = 0u; m < na.size(); ++m)
        {
            ...
            ublas::detail::recursive::mtv(size_type(m), c.data(), nc.data(), wc.data(), a.data(), na.data(), wa.data(),
                                          b.data());
...
BOOST_FIXTURE_TEST_CASE_TEMPLATE(test_tensor_mtm, value, test_types, fixture)
{
    ...
    for (auto const &na : extents)
    {
        ...
        ublas::detail::recursive::mtm(c.data(), nc.data(), wc.data(), a.data(), na.data(), wa.data(), b.data(),
                                      nb.data(), wb.data());
...
BOOST_FIXTURE_TEST_CASE_TEMPLATE(test_tensor_ttv, value, test_types, fixture)
{
    ...
    for (auto const &na : extents)
    {
        ...
        for (auto m = 0u; m < na.size(); ++m)
        {
            ...
            ublas::ttv(size_type(m + 1), na.size(), c.data(), nc.data(), wc.data(), a.data(), na.data(), wa.data(),
...
BOOST_FIXTURE_TEST_CASE_TEMPLATE(test_tensor_ttm, value, test_types, fixture)
{
    ...
    for (auto const &na : extents)
    {
        ...
        for (auto m = 0u; m < na.size(); ++m)
        {
            ...
            ublas::ttm(size_type(m + 1), na.size(), c.data(), nc.data(), wc.data(), a.data(), na.data(), wa.data(),
                       b.data(), nb.data(), wb.data());
    ...
    for (auto const &na : extents)
    {
        ...
        for (auto i = 0u; i < f; ++i)
        {
            ...
            for (auto q = size_type(0); q <= pa; ++q)
            {
                ...
                ublas::ttt(pa, pb, q, pia.data(), pib_inv.data(), c.data(), nc.data(), wc.data(), a.data(), na.data(),
...
BOOST_FIXTURE_TEST_CASE_TEMPLATE(test_tensor_ttt, value, test_types, fixture)
{
    ...
    for (auto const &na : extents)
    {
        ...
        { // pa
            ...
            ublas::ttt(pa, pb, q, c.data(), nc.data(), wc.data(), a.data(), na.data(), wa.data(), b.data(), nb.data(),
                       wb.data());
...
BOOST_FIXTURE_TEST_CASE_TEMPLATE(test_tensor_outer, value, test_types, fixture)
{
    ...
    for (auto const &na : extents)
    {
        ...
        for (auto const &nb : extents)
        {
            ...
            ublas::outer(c.data(), nc.size(), nc.data(), wc.data(), a.data(), na.size(), na.data(), wa.data(), b.data(),
                         nb.size(), nb.data(), wb.data());
